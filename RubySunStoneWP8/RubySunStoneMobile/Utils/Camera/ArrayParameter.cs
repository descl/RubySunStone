    ...
    public class FocusIlluminationModeParameter : ArrayParameter
    {
        ...
        protected override void PopulateOptions()
        {
            ...
            foreach (dynamic i in supportedValues)
            {
                ...
                //BL ArrayParameterOption option = new ArrayParameterOption(fim, fim.EnumerationToParameterName<FocusIlluminationMode>());
    ...
    public class AutoFocusRangeParameter : ArrayParameter
    {
        ...
        protected override void PopulateOptions()
        {
            ...
            foreach (dynamic i in supportedValues)
            {
                ...
                //BL ArrayParameterOption option = new ArrayParameterOption(afr, afr.EnumerationToParameterName<AutoFocusRange>());
